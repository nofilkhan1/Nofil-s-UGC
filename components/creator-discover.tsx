...
import { Camera, ExternalLink, Music2, Search } from "lucide-react";
...
export type DiscoverCreator = { id: string; display_name: string; creator_profiles: Array<{ bio: string | null; portfolio_url: string | null; instagram_handle: string | null; tiktok_handle: string | null; niches: Niche[] }> };
